...
export default class modifyMeme extends Component {
  ...
  onSearch(e) {
    e.preventDefault();
    Axios.get(
      `https://api-meme-backend.herokuapp.com/memes/modifyMeme/${
        this.state._id
      }`
    ).then(res =>
      this.setState({
  ...
  onSubmit(e) {
    ...
    Axios.put(
      `https://api-meme-backend.herokuapp.com/memes/${this.state._id}`,
      data
    ...
    return (
      <div>
        ...
        <form onSubmit={this.onSubmit} className="form">
          <input
            className="input-formulario-subida"
            type="text"
            name="name"
            placeholder="Nombre"
          ...
          <input
            ...
            onChange={this.onChangeCalificacion}
            required
          />
